...
ax0.plot(range(1,iterations), [time for time in total_time["largura"]], '-', color="#707070", linewidth=2.5, alpha = 0.7, label='Largura')
ax0.plot(range(1,iterations), [time for time in total_time["montanha"]], '-', color="#707070", linewidth=2.5, alpha = 0.7, label='Subida da Montanha')
ax0.plot(range(1,iterations), [time for time in total_time["a_*"]], '-', color="#707070", linewidth=2.5, alpha = 0.7, label='A*')
...
ax0.plot(range(1,iterations), [time for time in nodes["largura"]], '-', color="#707070", linewidth=2.5, alpha = 0.7, label='Largura')
ax0.plot(range(1,iterations), [time for time in nodes["montanha"]], '-', color="#707070", linewidth=2.5, alpha = 0.7, label='Subida da Montanha')
ax0.plot(range(1,iterations), [time for time in nodes["a_*"]], '-', color="#707070", linewidth=2.5, alpha = 0.7, label='A*')
ax0.legend(loc='upper right', shadow=False, prop={'size':12})
ax0.set_xlabel('Número de ratos (em dezenas)', fontsize=13)
...
ax0.plot(range(1,iterations), [time for time in cost["largura"]], '-', color="#707070", linewidth=2.5, alpha = 0.7, label='Largura')
ax0.plot(range(1,iterations), [time for time in cost["montanha"]], '-', color="#707070", linewidth=2.5, alpha = 0.7, label='Subida da Montanha')
ax0.plot(range(1,iterations), [time for time in cost["a_*"]], '-', color="#707070", linewidth=2.5, alpha = 0.7, label='A*')
ax0.legend(loc='upper right', shadow=False, prop={'size':12})
ax0.set_xlabel('Número de ratos (em dezenas)', fontsize=13)
